...
### 🗂️ [DIT PYQ Hub](https://github.com/Aditgm/DIT-PYQ-hub) — Full-Stack Academic Resource Platform (PWA)
...
- 🌐 **Offline-capable PWA** — Workbox 7.x multi-strategy caching (NetworkFirst · CacheFirst · StaleWhileRevalidate)
- 🚀 **CI/CD pipeline** — GitHub Actions automated integration testing + zero-downtime SSH deployment on DigitalOcean
- 📉 **Sub-50ms UI sync** — TanStack Query v5 optimistic updates + Supabase Realtime `postgres_changes`
- 🛡️ Sliding-window rate limiting (5 req/3hr) · Zod schema validation · watermarked file delivery · 99.9% uptime
...
### ⚖️ [Legal Lens](https://github.com/Aditgm/Legal_Lens) — AI-Powered Legal Research Platform
> RAG pipeline making statutory research accessible to everyone.

- 🤖 **Llama 3.3 (70B)** — context-aware legal insights via Retrieval-Augmented Generation
- 🔍 **Pinecone Vector DB** — 1,000+ chunked legal documents indexed for embedding-based semantic retrieval
...
### 🦟 [Dengue-Spot](https://github.com/Aditgm/dengue-spot) — Real-Time Disease Surveillance Platform
> Community-driven public health platform with live geo-tagged risk mapping.

- 📡 **Socket.io** — bi-directional real-time community chat and live alert broadcasting
- 🧠 **Roboflow CV pipeline** — auto-classifies mosquito breeding sites from user-uploaded images
- 🔒 **RBAC + Rate Limiting + IP Banning** — hardened REST API against abuse
- 🗺️ Indexed MongoDB geospatial queries · OAuth 2.0 auth · request logging & monitoring
